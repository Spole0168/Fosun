...
//    var obj = data[0].series;
				...
				return{
					restrict:'E',
					template:'<div class="file-upload"><!--上传--><form class="file-img"><label>'+
					'<input type="file" accept="image/gif, image/jpeg,image/png"/>'+
					'</label></form><!--圆形进度条--><div class="file-upload-progress"><ul class="list">'+
					'</ul><div class="file-upload-progress-inner"><span>100%</span></div>'+
					'</div><!--下载--><div class="download clearfix"><div class="download-left pull-left">'+
					'<img src="../../scube_ui/images/downloading_02.png"/></div></div>'+
					'<!--文件上传--><form class="file-text">'+
					'</form><!--上传缩略图--> <div class="upload-img"><!--上传中--><div class="pic loading">'+
					'<div class="pic-del"></div><div class="pic-text"><p>互联网消费信贷系统客户管理模块需求文档说明书.docx</p>'+
					'<h5>179MB</h5><span>2016/6/27</span></div></div><!--上传成功--><div class="pic success">'+
					'<div class="pic-del"></div><div class="pic-text"><p>互联网消费信贷系统客户管理模块需求文档说明书.docx</p>'+
					'<h5>179MB</h5><span>2016/6/27</span></div></div><!--excel--><div class="pic-big clearfix">'+
					'<div class="pic-big-left pull-left"><img src="../../scube_ui/images/download.png"></div>'+
					'<div class="pic-big-right"><p>互联网消费信贷系统客户管理模块需求文档说明书.xlsx</p><h5>179MB</h5>'+
					'<span>2016/6/27</span></div></div><!--word--><div class="pic-big clearfix"><div class="pic-big-left pull-left">'+
					'<img src="../../scube_ui/images/download-1.png"></div><div class="pic-big-right"><p>互联网消费信贷系统客户管理模块需求文档说明书.docx</p>'+
					'<h5>179MB</h5><span>2016/6/27</span></div></div><!--ppt--><div class="pic-big clearfix">'+
					'<div class="pic-big-left pull-left"><img src="../../scube_ui/images/download-2.png"></div>'+
					'<div class="pic-big-right"><p>互联网消费信贷系统客户管理模块需求文档说明书.pptx</p><h5>179MB</h5>'+
					'<span>2016/6/27</span></div></div></div></div>',
					controller:function ($scope) {
						var oUl=$('.list');
						var aLi = '<li></li>';
						var count=0;
