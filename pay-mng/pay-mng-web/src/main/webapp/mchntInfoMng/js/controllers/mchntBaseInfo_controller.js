 ...
 */
var mchntBaseInfoController = function ($scope, $common, dataDeliver, $state) {
    var data = dataDeliver.getter();
    var mchntId = data.mchntId;
    var param = {"mchntId": mchntId};
    ...
    var promise = $common.get_asyncData("mchntMngService/findMchntBaseInfo", param);
    promise.then(function (res) {
        $scope.customerForm;
        if (res.errorCode == "SUC") {
            $scope.mchntBaseInfoForm = res.contextData;
