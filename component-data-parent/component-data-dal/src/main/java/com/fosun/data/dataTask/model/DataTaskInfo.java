...
public class DataTaskInfo implements Serializable {
    ...
    public void setOutFileId(String outFileId) {
        this.outFileId = outFileId == null ? null : outFileId.trim();
    }

    /**
     * VARCHAR(1)<br>
     * 获得 请求状态：1处理中，2：完成，3：错误 
     */
    ...
    public String toString() {
        ...
        sb.append(", outFileId=").append(outFileId);
    ...
    public boolean equals(Object that) {
        ...
        DataTaskInfo other = (DataTaskInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOutFileId() == null ? other.getOutFileId() == null : this.getOutFileId().equals(other.getOutFileId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOutFileId() == null) ? 0 : getOutFileId().hashCode());
